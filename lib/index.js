...
var raylib = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, raylib_1.default), wrappers), colors), camera), audio), enums), maths), misc), texture), models), shaders), { Camera: camera.Camera3D });
